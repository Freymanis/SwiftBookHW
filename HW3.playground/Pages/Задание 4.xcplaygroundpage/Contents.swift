 ...
 */
let alarmMessage = Alarm.A

enum Alarm: String {
    case C = "Соблюдать спокойствие"
    case B = "Закрыть входные двери и окна"
    case A = "Выключить все электрические приборы"
}


switch alarmMessage {
case .A:
    print(Alarm.A.rawValue)
    fallthrough
case .B:
    print(Alarm.B.rawValue)
    fallthrough
case .C:
    print(Alarm.C.rawValue)
}
